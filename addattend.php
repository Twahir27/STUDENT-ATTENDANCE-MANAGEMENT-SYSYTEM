...
<div class="" id="body" style="; width:98%;height:669px; margin:auto;">
	...
	<div class="row">	
		...
		<div class="col-md-2" style="border:0px solid;margin:0;padding:0;background-color:#EBF4FA;min-height:469px">
		<div     id="list">
			<?php
		...
		<div class="col-md-10" style="border:0px solid;min-height:475px;background-color:#FFFAFA">
		
		     
		
			<?php
					require_once("form/add_attendance.php");
