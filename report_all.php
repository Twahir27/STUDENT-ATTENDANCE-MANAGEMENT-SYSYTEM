...
<div class="" id="body" style="; width:98%;height:669px; margin:auto;">
	...
	<div class="row">	
		...
		<div class="col-md-10" style="border:0px solid;height:470px;background-color:#FFFAFA;overflow-y: scroll;">
		
		     
		
			<?php
					require_once("form/view_report_all.php");
...
<div class="row"  style="border:px solid;background-color:#ADD8E6;height:20px">
	  <center><b><i>student management @.sayko</center>
	</div>
