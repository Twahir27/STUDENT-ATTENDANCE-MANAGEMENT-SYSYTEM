...
<div class="" id="body" style="; width:98%;height:669px; margin:auto;">
	...
	<div class="row" style="border:0px solid;background-color:#ADD8E6;min-height:150px;">
			...
			<div id="leftlogo" ><img src="image/suza.jpg" width="160px"     class="img-circle"></div>
	...
	<div class="row">	
		...
		<div class="col-md-10" style="border:0px solid;min-height:475px;background-color:#F5F5F5">
		
		     
		
			<?php
					require_once("form/updatestudent_form.php");
